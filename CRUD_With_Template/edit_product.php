<?php
    ...
    if($_POST)
    {
        ...
        $query= mysqli_query($connection,"update tbl_product set pro_name='{$pname}',pro_price='{$pprice}',pro_detail='{$pdetail}' where pro_id='{$id}'") or die(mysqli_error($connection));

        if($query)
        {
            echo "<script>alert('Record Updated');window.location='display_product.php';</script>";
        }
    }
?>
<!DOCTYPE HTML>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                   ...
                                   <div class="col-sm-offset-2"> 
                                         ...
                                         <button type="button" class="btn btn-info" onclick="window.location='display_product.php';">View</button>
                                    </div> 
                                </form> 
							</div>
						</div>
