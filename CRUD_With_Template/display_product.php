...
<body class="cbp-spmenu-push">
    ...
    <?php
        ...
        include './themepart/header_menu.php';
    ?>
		<!-- header-starts -->
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="panel-body widget-shadow">
                        ...
                        <img src='./images/add_icon.png' height='15px' width='15px'> <a href='add_product.php'>Add Product</a> <br><br>
						<table class="table">
							<thead>
								<tr>
								  <th> Id</th>
                            ...
                            <?php
                                ...
                                while($productrow = mysqli_fetch_array($selectq))
                                {
                                    ...
                                    echo "<td>{$productrow['pro_detail']}</td>";
                                    echo "<td><img src='./images/edit_icon.png' height='20px' width='20px'><a href='edit_product.php?eid={$productrow['pro_id']}'>Edit</a> | <img src='./images/delete_icon.png' height='15px' width='15px'> <a href='display_product.php?did={$productrow['pro_id']}'>Delete</a></td>";
                                    echo "</tr>";
                                }
                            ?>	
							</tbody>
